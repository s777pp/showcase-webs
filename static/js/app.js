      ...
      xhr.onload = async function () {
        ...
        try {
          ...
          if (window.ProcessResult && await window.ProcessResult.open(job, jid, processOriginals)) {
            ...
            st.textContent = ru ? 'Обработка завершена. ZIP скачивается автоматически; проверь готовность комплекта к Steam.' : 'Processing complete. The ZIP is downloading automatically; review Steam readiness.';
            dl.style.display = 'none';
...
const APP_I18N = window.APP_I18N = {
  ru: {
    ...
    steam_folder_hint: "После обработки распакуй ZIP, который скачался автоматически, — это готовые файлы. Браузер не может открыть локальную папку сам.",
    ...
    steam_how_items: [
      "Нажми «К вкладке Process» — обработай и распакуй скачанный ZIP",
  ...
  en: {
    ...
    steam_folder_hint: "After Process, unpack the ZIP downloaded automatically — those are your files. The browser cannot open a local folder for you.",
...
(function () {
  var DICT = {
    en: {
      ...
      up_h: "Upscale",
      up_desc: "AI upscaling for images, GIFs and video. Jobs continue in the background.",
      up_pro_h: "Pro only",
      ...
      steam_step3: "3. Console code (F12)",
      steam_step4: "4. Which files to upload",
      steam_folder_hint: "After Process, unpack the ZIP that downloaded automatically — those are your files.",
      steam_open_folder: "Open Process tab",
      steam_open_page: "Open Steam page",
      steam_blank: "Copy blank character",
      steam_blank_ok: "Blank character copied (ㅤ)",
      steam_video_cap: "Video guide: how to upload to Steam",
      steam_ext_checking: "Checking extension…", steam_ext_kicker: "STEAMSHOWCASE HELPER", steam_ext_title: "Upload without console setup",
      steam_ext_body: "Choose a showcase type, then open file selection for automatic upload or use the manual Steam handoff.",
      steam_ext_step_1: "Choose one of the three showcase types below.", steam_ext_step_2: "Automatic: select files in the extension and start the queue.",
      steam_ext_step_3: "Manual: open Steam and choose the files yourself.", steam_ext_install: "Install extension",
      steam_ext_mode_label: "What are you uploading?", steam_ext_mode_workshop: "5 files", steam_ext_mode_featured: "1 file", steam_ext_mode_split: "2 files",
      steam_ext_picker: "Open file selection", steam_ext_upload: "Manual extension upload", steam_ext_note: "Automatic upload selects files inside the extension. Manual upload lets you choose them on Steam.",
      steam_copy: "Copy code",
      steam_how: "Step-by-step",
      steam_how_1: "Run Process and unpack the automatically downloaded ZIP",
    ...
    ru: {
      ...
      up_h: "Апскейл",
      up_desc: "ИИ-апскейл изображений, GIF и видео. Задача продолжает выполняться в фоне.",
      ...
      steam_step3: "3. Код для консоли (F12)",
      steam_step4: "4. Какие файлы грузить",
      steam_folder_hint: "После обработки распакуй ZIP, который скачался автоматически, — это готовые файлы.",
      steam_open_folder: "К вкладке Process",
      steam_open_page: "Открыть страницу Steam",
      steam_blank: "Скопировать пустой символ",
      steam_blank_ok: "Пустой символ скопирован (ㅤ)",
      steam_video_cap: "Видео-инструкция: как загружать в Steam",
      steam_ext_checking: "Проверяем расширение…", steam_ext_kicker: "STEAMSHOWCASE HELPER", steam_ext_title: "Загрузка без настройки консоли",
      steam_ext_body: "Выбери тип витрины. Для автозагрузки открой выбор файлов или воспользуйся ручной передачей в Steam.",
      steam_ext_step_1: "Выбери один из трёх типов витрины ниже.", steam_ext_step_2: "Автоматически: выбери файлы в расширении и запусти очередь.",
      steam_ext_step_3: "Вручную: открой Steam и выбери файлы сам.", steam_ext_install: "Установить расширение",
      steam_ext_mode_label: "Что загружаем?", steam_ext_mode_workshop: "5 файлов", steam_ext_mode_featured: "1 файл", steam_ext_mode_split: "2 файла",
      steam_ext_picker: "Открыть выбор файлов", steam_ext_upload: "Ручная загрузка через расширение", steam_ext_note: "Для автозагрузки выбирай файлы в расширении. При ручной загрузке — на странице Steam.",
      steam_copy: "Копировать код",
      steam_how: "Пошаговая инструкция",
      steam_how_1: "Обработай файлы и распакуй автоматически скачанный ZIP",
