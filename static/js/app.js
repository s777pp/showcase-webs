...
(function () {
  var DICT = {
    en: {
      ...
      steam_ext_body: "Install the extension, open the required showcase uploader and choose your prepared files. The extension applies the transparent title and long-showcase settings automatically.",
      steam_ext_step_1: "Choose the showcase type on this page.", steam_ext_step_2: "Open the Steam upload page.",
      steam_ext_step_3: "Select your files — the extension handles the remaining setup.", steam_ext_install: "Install extension",
      steam_ext_note: "Without the extension, use the manual steps on the left.",
      steam_copy: "Copy code",
      steam_how: "Step-by-step",
    ...
    ru: {
      ...
      steam_ext_body: "Установи расширение, открой загрузчик нужной витрины и выбери подготовленные файлы. Прозрачное название и настройки длинной витрины расширение применит автоматически.",
      steam_ext_step_1: "Выбери тип витрины на этой странице.", steam_ext_step_2: "Открой страницу загрузки Steam.",
      steam_ext_step_3: "Выбери файлы — остальную настройку выполнит расширение.", steam_ext_install: "Установить расширение",
      steam_ext_note: "Без расширения используй ручную инструкцию слева.",
      steam_copy: "Копировать код",
      steam_how: "Пошаговая инструкция",
