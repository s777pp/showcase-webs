...
(function () {
  var DICT = {
    en: {
      ...
      steam_ext_body: "Choose a showcase type and start the upload. The extension opens the correct Steam page, applies its settings and shows the file order.",
      steam_ext_step_1: "Choose one of the three showcase types below.", steam_ext_step_2: "Click «Upload through extension».",
      steam_ext_step_3: "Select your files — the extension handles the remaining setup.", steam_ext_install: "Install extension",
      ...
      steam_ext_upload: "Upload through extension", steam_ext_note: "Files stay on your computer: choose them on the Steam page opened by the extension.",
      steam_copy: "Copy code",
      steam_how: "Step-by-step",
    ...
    ru: {
      ...
      steam_ext_body: "Выбери тип витрины и запусти загрузку. Расширение откроет нужную страницу Steam, применит настройки и покажет порядок файлов.",
      steam_ext_step_1: "Выбери один из трёх типов витрины ниже.", steam_ext_step_2: "Нажми «Загрузить через расширение».",
      steam_ext_step_3: "Выбери файлы — остальную настройку выполнит расширение.", steam_ext_install: "Установить расширение",
      ...
      steam_ext_upload: "Загрузить через расширение", steam_ext_note: "Файлы остаются на компьютере: выбери их на странице Steam, которую откроет расширение.",
      steam_copy: "Копировать код",
      steam_how: "Пошаговая инструкция",
