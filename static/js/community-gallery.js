(function () {
  ...
  dict.en.archiveHint = 'Ready ZIP: Workshop needs 5 parts; Artwork Split needs 506 + 100 px; Featured needs one 630 px image. Each Steam part must be under 5 MB.';
  dict.ru.archiveHint = 'Готовый ZIP: Мастерская — 5 частей; Иллюстрации — 506 + 100 px; Избранные иллюстрации — одна картинка 630 px. Каждая часть — до 5 МБ.';
  ...
  function serverError(data) {
    ...
    const known = {
      'ZIP is not a complete Steam-ready set for this showcase type': 'Архив не подходит для выбранной витрины: проверь количество частей, размеры и лимит 5 МБ.',
      ...
      'Add the ready ZIP': 'Добавь ZIP с готовыми частями.',
